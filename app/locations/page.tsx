          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-gray-300 mb-6">
                Purbayan Properties Limited is strategically located in one of the most promising areas of Bangladesh,
                offering excellent connectivity to major roads, business districts, educational institutions, and
              ...
              <div className="flex items-center mb-6">
                ...
                <address className="not-italic text-lg">House-35 (5th floor), Road-7, Block-G, Banani, Dhaka.</address>
              </div>
              <Button className="bg-[#f8c927] text-black hover:bg-[#f8c927]">Get Directions</Button>
            </div>
