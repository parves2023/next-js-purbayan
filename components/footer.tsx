    ...
    <footer className="bg-gray-900 border-t border-gray-800">
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-4 text-center md:text-left">
              <li className="flex items-center justify-center md:justify-start text-gray-400">
                ...
                <Link href="tel:01713034079" className="hover:text-amber-500 transition-colors">
                  CALL 01713034079
                </Link>
              </li>
              <li className="flex items-center justify-center md:justify-start text-gray-400">
          ...
          <div>
            <h3 className="text-white font-bold text-lg mb-4 text-center md:text-left">More Info</h3>
            <ul className="space-y-2 text-center md:text-left">
              <li>
                <Link href="/plot-booking" className="text-gray-400 hover:text-amber-500 transition-colors">
                  Plot Booking Form
                </Link>
              </li>
              <li>
        ...
        <div className="border-t border-gray-800 mt-12 pt-6 text-center">
          <p className="text-gray-400 text-sm">© {currentYear} Large iT, All Rights Reserved</p>
        </div>
      </div>
    </footer>
  )
