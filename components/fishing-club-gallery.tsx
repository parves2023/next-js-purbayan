...
export default function FishingClubGallery() {
  ...
  const galleryImages: GalleryImage[] = [
    {
      src: "https://i.ibb.co.com/spRvGwP0/12.jpg",
      alt: "Fishing Club Main View",
      className: "row-span-2 md:col-span-1 col-span-2",
    },
    {
      src: "https://i.ibb.co.com/5gFS98tT/7.jpg",
      alt: "Fishing Club Lake",
      className: "row-span-1 col-span-2",
    },
    {
      src: "https://i.ibb.co.com/xtRvRvkV/1.jpg",
      alt: "Fishing Activities",
      className: "row-span-1 col-span-1",
    },
    {
      src: "https://i.ibb.co.com/PzWF9T8y/2.jpg",
        ...
        {selectedImage && (
          ...
          >
            <div className="relative max-w-5xl w-full max-h-[90vh]" onClick={(e) => e.stopPropagation()}>
              ...
              <button
                className="absolute top-2 right-8 bg-gray-400 text-white rounded-full p-2"
                onClick={closeModal}
